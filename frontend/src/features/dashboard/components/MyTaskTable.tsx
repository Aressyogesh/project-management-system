              ...
              tasks.map((task) => (
                ...
                >
                  <td className="py-3 pr-4">
                    <p className="font-medium text-gray-800 truncate max-w-[180px]">{task.projectName}</p>
                    <p className="text-xs text-gray-400 mt-0.5 truncate max-w-[180px]">{task.taskName}</p>
                  </td>
                  <td className="py-3 pr-4">
