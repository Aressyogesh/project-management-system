...
export function BoardToolbar({
  ...
  return (
    <div className="flex flex-col gap-2">
      {/* Row 1: Backlog toggle · view toggle · Import · Create */}
      ...
      {/* Row 2: Filters — always rendered so layout never shifts */}
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {/* Clear — always rendered to prevent layout shift; disabled when no filters active */}
        <button
