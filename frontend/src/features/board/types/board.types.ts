...
export type BoardStatus = 'TODO' | 'IN_PROGRESS' | 'BLOCKED' | 'IN_REVIEW' | 'READY_FOR_QA' | 'IN_QA' | 'QA_DONE' | 'ACKNOWLEDGED' | 'CLOSED' | 'QA';
...
export const DEFAULT_BOARD_COLUMNS: { status: BoardStatus; label: string; color: string; headerClass: string }[] = [
  ...
  { status: 'ACKNOWLEDGED', label: 'Acknowledged',    color: '#f97316', headerClass: 'bg-orange-100 text-orange-700' },
