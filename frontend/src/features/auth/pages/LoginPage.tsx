          ...
          {view === 'login' ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
                ...
                {/* Submit: circular button + clickable label */}
            ...
            <>
              ...
              {forgotStatus !== 'sent' ? (
                  ...
                  <form onSubmit={handleForgotSubmit} noValidate className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        autoFocus
                        className={`w-full px-4 py-3 rounded-lg border text-sm outline-none transition focus:ring-2 focus:ring-blue-400 focus:border-blue-400 ${forgotEmailError ? 'border-red-400 bg-red-50' : 'border-gray-300'}`}
                      />
                      {forgotEmailError && <p className="mt-1 text-xs text-red-500">{forgotEmailError}</p>}
                    </div>

                    {/* Submit: same circular button style as sign-in */}
                    <div className="flex items-center gap-4 pt-2">
                      <button
                        type="submit"
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {/* Back to sign-in: same circular button style */}
                  <div className="flex items-center gap-4 pt-2">
                    <button
                      type="button"
                      onClick={goToLogin}
                      className="w-12 h-12 rounded-full flex items-center justify-center shrink-0 transition shadow-md"
                      style={{ background: '#1a6ab1' }}
